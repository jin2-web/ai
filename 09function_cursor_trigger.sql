...
-- 요구사항 - 입력할 때 생일 잘못 입력되지 않도록 1900이전 입력이면 0 입력 또는 올해 년도보다 이후의 년도 입력 되었어 0 입력 
delimiter //
create trigger ubi 
  before insert
  on usertbl
...
insert into usertbl values('FFF','에프에', 1877, '평양','011','1111111',181,'2019-12-25','잠재고객' );
